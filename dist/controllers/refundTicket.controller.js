...
exports.refundTicketController = void 0;
const prisma_1 = require("../config/prisma");
exports.refundTicketController = {
    ...
    async createTicket(req, res) {
        try {
            ...
            const offlineClass = await prisma_1.prisma.offlineClass.findUnique({
            ...
            const ticket = await prisma_1.prisma.refundTicket.create({
                data: {
    ...
    async getTickets(req, res) {
        try {
            ...
            const tickets = await prisma_1.prisma.refundTicket.findMany({
                where,
    ...
    async adminProcessTicket(req, res) {
        try {
            ...
            const ticket = await prisma_1.prisma.refundTicket.findUnique({
            ...
            // Action: REJECT
            if (status === 'REJECTED') {
                const updatedTicket = await prisma_1.prisma.refundTicket.update({
                    where: { ticket_id: ticketId },
                    data: {
                        status: 'REJECTED',
            ...
            const [updatedTicket] = await prisma_1.prisma.$transaction([
                prisma_1.prisma.refundTicket.update({
                    where: { ticket_id: ticketId },
                    data: {
                ...
                prisma_1.prisma.offlineClass.update({
                ...
                ...(studentPayment
                    ? [
                        prisma_1.prisma.offlineClassPayment.update({
