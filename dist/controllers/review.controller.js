...
exports.reviewController = {
    async getVisibleReviews(req, res) {
        try {
            const reviews = await review_repository_1.reviewRepository.findVisibleReviews();
    ...
    async createReview(req, res) {
        try {
            ...
            const existingReview = await review_repository_1.reviewRepository.findReviewByBookingId(booking_id);
            if (existingReview) {
            ...
            const review = await review_repository_1.reviewRepository.insert({
                booking_id,
