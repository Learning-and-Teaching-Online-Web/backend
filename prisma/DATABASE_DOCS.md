...
| **09** | **Quiz** | Quản lý ngân hàng câu hỏi trắc nghiệm/tự luận, tạo đề thi AI và kết quả làm bài. | `quizzes`, `quiz_questions`, `quiz_options`, `quiz_attempts`<br>*ENUMs:* `QuizQuestionType`, `QuizStatus` | 📄 [MODULE_09_QUIZ.md](file:///d:/cod/thuctap/backend/prisma/docs/MODULE_09_QUIZ.md) |
